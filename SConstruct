...
import re
import sys
# Check for the python version number so we know which version of ConfigParser to use
...
conf = parser.SafeConfigParser(allow_no_value = True)
...
ambit_conf = parser.SafeConfigParser(allow_no_value = True)
