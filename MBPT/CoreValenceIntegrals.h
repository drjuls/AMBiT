...
public:
    ...
    CoreValenceIntegrals(pOrbitalManagerConst orbitals, pHFElectronOperatorConst one_body, pHartreeY hartreeY_op);

    /** Specify container object for bare integrals. */
    CoreValenceIntegrals(pOrbitalManagerConst orbitals, pHFElectronOperatorConst one_body, pSlaterIntegrals bare_integrals);
