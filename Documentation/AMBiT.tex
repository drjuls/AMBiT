...
\option{-{}-brueckner-use-lower} Include matrices between upper and lower components of wavefunction ($f$ and $g$) in $\Sigma$ potential.

\option{-{}-brueckner-use-lower-lower} Include lower-lower $\Sigma$ matrix (between $g$ and $g$).
