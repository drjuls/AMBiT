...
\option{-{}-self-energy} Include QED self-energy radiative potential in HF operator.

\option{-{}-hard-sphere-QED} Use hard sphere instead of nuclear distribution for QED operators (Uehling and self-energy).

\option{-{}-include-QED-screening} Include core electron screening when calculating QED operators. Cannot be used with \code{-{}-hard-sphere-QED}.
