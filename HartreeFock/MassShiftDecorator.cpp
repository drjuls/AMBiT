...
MassShiftDecorator::MassShiftDecorator(OneBodyOperator* wrapped_OBO, SpinorODE* wrapped_ODE, OPIntegrator* integration_strategy):
...
SpinorFunction MassShiftDecorator::GetExchange(const SingleParticleWavefunction* approximation) const
{
