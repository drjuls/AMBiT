...
typedef std::shared_ptr<SingleParticleWavefunction> pSingleParticleWavefunction;
typedef std::shared_ptr<const SingleParticleWavefunction> pSingleParticleWavefunctionConst;
